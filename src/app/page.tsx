...
export default async function HomePage() {
  return (
    <div className='md:grid md:grid-cols-2 md:gap-24 md:pb-5'>
      <div className='space-y-4 md:grid md:grid-rows-[auto,auto,auto,5rem]'>
        <h1 className='text-center text-6xl font-medium text-fuchsia-300 md:pb-0 md:text-left md:text-8xl'>
        ...
        <div className='flex items-center justify-center gap-5 md:justify-start md:pb-0'>
          <button className='w-32 rounded-md bg-blue-500 p-5 font-semibold text-slate-50'>
            Learn More
          </button>
          <button className='w-32 rounded-md bg-fuchsia-400 p-5 font-semibold text-zinc-950'>
            Contact
          </button>
        </div>
